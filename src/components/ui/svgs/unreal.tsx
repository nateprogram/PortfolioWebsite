...
// Unreal Engine mark, from Simple Icons (CC0). Uses currentColor so the
// logo stays legible on both light and dark backgrounds.
const Unreal = (props: SVGProps<SVGSVGElement>) => (
